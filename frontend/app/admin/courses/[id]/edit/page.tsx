                                                ...
                                                <select
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        if (e.target.value === 'fill') {
                                                            ...
                                                            newQuiz[idx].options = q.options?.length > 0 ? q.options : ['A) Option 1', 'B) Option 2', 'C) Option 3', 'D) Option 4'];
                                                        }
                                                        setQuiz(newQuiz);
                                                    }}
                                                ...
                                                {(q.options || []).map((opt, optIdx) => (
                                                    <div key={optIdx} className="flex items-center gap-2">
                                                        ...
                                                        <button
                                                            onClick={() => {
                                                                const newQuiz = [...quiz];
                                                                newQuiz[idx].options = newQuiz[idx].options.filter((_, i) => i !== optIdx);
                                                                setQuiz(newQuiz);
                                                            }}
                                                            className="text-red-500 hover:text-red-700"
                                                        >
